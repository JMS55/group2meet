defmodule Group2meetWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Group2meetWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Group2meetWeb.Gettext, "errors", msg, opts)
    end
  end
